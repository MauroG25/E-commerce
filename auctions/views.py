...
from .utils import CreateListingForm
...
def listing(request, listing_id):
    ...
    if request.method == "POST":
        if request.POST.get("comment") is not None:
            ...
            Comment.objects.create(user=user, listing_id=listing_id, comment = comment)
    ...
    bidding_msg = f"{listing.winner} won the auction of {listing.title} !!!!"
